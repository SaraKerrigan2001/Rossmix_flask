...
USUARIOS = [
    ...
    ('Maria Capacho',    'mariapaulacapachogonzalez@gmail.com','3006410764', 'cliente', '123456789', None),
    ('Cristian',         'cristianchaustre90@gmail.com', '3229615724', 'cliente', 'CLIENTE_PWD', None),
    ('Andrade',          'andrade.cliente@rossmix.com', '3216789088', 'cliente', CLIENTE_PWD, None),
